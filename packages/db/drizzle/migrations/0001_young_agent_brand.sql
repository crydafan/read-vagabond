...
INSERT INTO `__new_chapters`("id", "volume_id", "title", "number", "page_count", "release_date", "created_at") SELECT "id", "volume_id", "title", "number", "page_count", "release_date", "created_at" FROM `chapters`;--> statement-breakpoint
